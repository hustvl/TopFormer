...
model = dict(
    ...
    backbone=dict(
        type='Topformer',
        cfgs=cfgs_md1['cfg'], 
        channels=cfgs_md1['channels'],
        out_channels=cfgs_md1['out_channels'], 
        embed_out_indice=cfgs_md1['embed_out_indice'],
        decode_out_indices=cfgs_md1['decode_out_indices'],
        num_heads=cfgs_md1['num_heads'],
        depths=4,
        c2t_stride=cfgs_md1['c2t_stride'],
        drop_path_rate=0.1,
        norm_cfg=norm_cfg,
        init_cfg=dict(
